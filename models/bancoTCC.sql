...
-- Copiando dados para a tabela sistema_estoque.movimentacoes: ~27 rows (aproximadamente)
INSERT INTO `movimentacoes` (`id_movimentacao`, `id_produto`, `tipo`, `quantidade`, `unidade_medida`, `responsavel`, `projeto_experimento`, `observacoes`, `data_movimentacao`) VALUES
	(1, 14, 'saida', 0.70, 'kg', 'aa', 'aa', 'a', '2025-10-08 11:46:15'),
	...
	(5, 4, 'entrada', 0.70, 'L', 'aa', 'Fornecedor: aa', 'aaa', '2025-10-08 11:53:19'),
	(6, 19, 'entrada', 1.00, 'L', 'aa', 'Fornecedor: aa', 'aaa', '2025-10-08 11:53:58'),
	(7, 19, 'entrada', 1.00, 'L', 'aa', 'Fornecedor: aa', 'a', '2025-10-08 11:55:47'),
	(8, 4, 'entrada', 0.90, 'L', 'aa', 'Fornecedor: aa', 'aaa', '2025-10-08 11:57:59'),
	(9, 14, 'entrada', 1.00, 'kg', 'Policate', 'Fornecedor: Senai', 'Entrada registrada por Policate. Data de compra: 2025-10-09', '2025-10-08 12:02:17'),
	(10, 4, 'entrada', 0.80, 'L', 'fgsa', 'Fornecedor: fafaf', 'faffa', '2025-10-08 12:02:33'),
	(11, 4, 'saida', 1.00, 'L', 'aa', 'aa', 'aa', '2025-10-08 12:02:51'),
	(12, 14, 'saida', 1.00, 'kg', 'aaa', 'aa', 'aa', '2025-10-08 12:02:57'),
	(13, 19, 'saida', 1.00, 'L', 'aaa', 'aaa', 'aa', '2025-10-08 12:03:04'),
	(14, 4, 'entrada', 1.00, 'L', 'aa', 'Fornecedor: aaa', 'aa', '2025-10-08 12:12:36'),
	(15, 4, 'entrada', 1.00, 'L', 'ee', 'Fornecedor: ee', 'ee', '2025-10-08 12:13:17'),
	(16, 4, 'saida', 1.00, 'L', 'aaaaa', 'aaaaaaa', 'aaaaa', '2025-10-08 13:23:17'),
	(17, 4, 'saida', 1.00, 'L', 'aaa', 'aaa', 'aaa', '2025-10-08 13:23:42'),
	(18, 4, 'entrada', 1.00, 'L', 'aaa', 'Fornecedor: aaa', 'aa', '2025-10-08 13:24:03'),
	(19, 4, 'saida', 1.00, 'L', 'aaa', 'aa', 'aa', '2025-10-08 13:24:25'),
	(20, 4, 'saida', 1.00, 'L', 'aa', 'aa', 'aa', '2025-10-08 13:24:40'),
	(21, 4, 'entrada', 1.00, 'L', 'aaa', 'Fornecedor: aaa', 'aaa', '2025-10-08 13:29:51'),
	(22, 17, 'saida', 2.00, 'g', 'aa', 'aa', 'aa', '2025-10-08 13:30:04'),
	(23, 4, 'entrada', 1.00, 'L', 'aa', 'Fornecedor: aaa', 'aa', '2025-10-08 14:17:03'),
	(24, 4, 'entrada', 3.00, 'L', 'aaa', 'Fornecedor: aa', 'aa', '2025-10-08 14:18:15'),
	(25, 4, 'saida', 3.00, 'L', 'JVL', 'Química ', 'Saída registrada por JVL', '2025-10-08 16:57:36'),
...
-- Copiando dados para a tabela sistema_estoque.produtos: ~35 rows (aproximadamente)
INSERT INTO `produtos` (`id_produto`, `nome`, `tipo`, `descricao`, `grau_periculosidade`, `orgao_regulador`, `instrucoes_seguranca`, `quantidade`, `estoque_minimo`, `unidade_medida`, `localizacao`, `disponivel`, `fornecedor`, `data_aquisicao`, `observacoes`, `data_criacao`, `data_atualizacao`) VALUES
	...
	(4, 'Ácido Clorídrico P.A.', 'Reagente Químico', 'Ácido clorídrico grau analítico 37%', 'alto', 'ANVISA', 'Usar em capela, luvas e óculos de segurança. Neutralizar com base fraca.', 10, 5, 'L', 'Armário 4 – Prateleira 2 – Posição 15', 1, 'Sigma-Aldrich', '2024-01-15', NULL, '2025-09-24 13:54:36', '2025-10-08 16:57:36'),
	...
	(14, 'Ágar Nutriente', 'Meio de Cultura', 'Meio sólido para microbiologia', 'baixo', 'ANVISA', 'Estéril. Preparar conforme instruções.', 13, 10, 'kg', 'Armário 6 – Prateleira 2 – Posição 8', 1, 'Kasvi', '2024-02-25', NULL, '2025-09-24 13:54:36', '2025-10-08 12:02:57'),
	...
	(17, 'Cloreto de Mercúrio II', 'Reagente Químico', 'Composto de mercúrio altamente tóxico', 'extremo', 'ANVISA', 'Manipular em capela química. Descarte específico obrigatório.', 0, 1, 'g', 'Armário Blindado – Prateleira 1 – Posição 2', 1, 'Merck', '2024-02-12', NULL, '2025-09-24 13:54:36', '2025-10-08 13:30:04'),
	...
	(19, 'Acetoneta P.A.', 'Solvente', 'Acetoneta grau HPLC 99.9%', 'alto', 'ANVISA', 'Altamente inflamável. Trabalhar em área ventilada.', 8, 8, 'L', 'Armário 7 – Prateleira 1 – Posição 4', 1, 'Tedia', '2024-01-28', NULL, '2025-09-24 13:54:36', '2025-10-08 12:03:04'),
	...
	(37, 'sss', 'reagente', 'sss', 'moderado', 'policia-federal', 'ss', 11, 9, 'kg', 'sss', 1, 'ss', '2025-10-31', 'sss', '2025-10-08 14:16:20', '2025-10-08 14:16:20');
